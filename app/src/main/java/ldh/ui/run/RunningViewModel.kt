...
class RunningViewModel : ViewModel() {
    ...
    fun uploadRunningData() {
        ...
        viewModelScope.launch {
            val success = NetworkRepository.uploadRunningDetail(
            ...
            if (success) ToastUtil.success(context.getString(R.string.upload_success))
            else ToastUtil.error(context.getString(R.string.upload_failed))
        }
    }
